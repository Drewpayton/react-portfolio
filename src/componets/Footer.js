export default function Footer() {
    return (
        <footer>
            <div class="footer">
                    <p class="footerText">
                        Website made by Drew Payton
                    </p>
                <div class="footText">
                    <a href="https://www.linkedin.com/in/drewpayton2018/" target='_blank' rel="noreferrer">
                    ...
                    <a href="https://github.com/Drewpayton" target='_blank' rel="noreferrer">
